...
public class MinCostToPaintWalls {
    public static void main(String[] args) {
        int[] cost = {1, 3, 4, 5};
        int[] time = {3, 1, 1, 2};
        MinCostToPaintWalls minCostToPaintWalls = new MinCostToPaintWalls();
        int result = minCostToPaintWalls.minCostToPaintWalls(cost, time);
        System.out.println(result);  // Output: 7
    }

    public int minCostToPaintWalls(int[] cost, int[] time) {
