...
public class BubbleSort {
    ...
    //Iterative Approach
    public static void bubbleSortUsing1DArraysIteratively(int[] arr) {
    ...
    //Iterative Approach
    public static void bubbleSortUsing2DArraysIteratively(int[][] arr) {
    ...
    public static void main(String[] args) {
        ...
        BubbleSort.bubbleSortUsing1DArraysIteratively(arr1D);   // using a 1D Array

        int[][] arr2D = {{5, 4, 7}, {1, 2, 3}, {6, 8, 9}};
        BubbleSort.bubbleSortUsing2DArraysIteratively(arr2D);  //using 2D array
    }
}
